...
/**
 * Platform-administratie-paneel: kwartaaloverzichten en openstaande betalingen over alle
 * samenwerkingen. Laadt zelf zijn data (admin-aggregatie, beheersbaar volume). Rendert geen
 * eigen paginakop — die hoort bij de route (/admin/administratie) of de hub (/admin/financien).
 */
                    ...
                    {collaborations.flatMap((c) =>
                      c.invoices.map((inv) => (
                        <tr key={inv.id} className="border-b border-border last:border-0">
                          ...
                          <td className="max-w-[200px] truncate px-4 py-3">{c.job.title}</td>
                          ...
                          <td className="px-4 py-3">
                            <Badge
                              variant={inv.lifecycleStatus === "OVERDUE" ? "warning" : "muted"}
                            >
