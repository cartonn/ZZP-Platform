...
import { BarChart3, Users, Handshake, FileText, ShieldCheck, AlertTriangle, ClipboardList } from "lucide-react";
...
function StatCard({
  ...
  if (href) {
    return (
      <Link href={href} className="block transition-colors hover:opacity-80 focus-ring rounded-lg">
        {inner}
      </Link>
    );
  }
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard
            label="Totaal"
            value={stats.performances.total}
          />
          <StatCard
