    ...
    <div className="space-y-6">
      ...
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          Importeer bestaande diensten vanuit een CSV-bestand of geplakt tekst. Elke regel wordt een
          afzonderlijke urenstaat die de opdrachtgever kan goedkeuren.
        </p>
      </header>
      ...
      <section className="rounded-lg border border-border bg-muted/20 p-4 text-sm">
        ...
        <p className="mt-1 text-muted-foreground">
          Semikolon-gescheiden, één dienst per regel. De kolom <code>omschrijving</code> is
          optioneel. Een kopregels-regel wordt automatisch overgeslagen.
        </p>
...
2024-01-20T06:00;2024-01-20T14:00;Vroege dienst`}
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          Tijdstempels: ISO-8601 of met spatie als scheidingsteken (bv. &ldquo;2024-01-15
          22:00&rdquo;). Avond/nacht/weekend/feestdagen worden automatisch afgeleid aan de hand van
          het ORT-profiel van de samenwerking. Maximaal 100 diensten per import.
        </p>
      </section>
    </div>
  );
