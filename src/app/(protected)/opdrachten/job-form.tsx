...
import { recommendModelAgreement, MODEL_AGREEMENT_LABELS, MODEL_AGREEMENT_TYPES } from "@/lib/model-agreement";
        ...
        <Field label="Vastgelegde modelovereenkomst" htmlFor="modelAgreementType">
          ...
          >
            ...
            {MODEL_AGREEMENT_TYPES.map((t) => (
              <option key={t} value={t}>{MODEL_AGREEMENT_LABELS[t]}</option>
            ))}
          </Select>
        </Field>
      </fieldset>
