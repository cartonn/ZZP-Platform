    ...
    <div className={styles.landing}>
      ...
      <header className={styles.header}>
        <Link href="/" className={styles.brand} aria-label="Handslag — home">
          <BrandMark size={34} />
          <span>
            handslag<span className={styles.brandDot}>.</span>
          </span>
        </Link>
      ...
      <main id="inhoud">
        <section className={styles.hero} aria-labelledby="hero-title">
          <div className={styles.heroCopy}>
            <p className={styles.eyebrow}>
              <span className={styles.dot} /> Samenwerken in de zorg
            </p>
            <h1 id="hero-title">
              Goed werk
              <br />
          ...
          <figure
            ...
            aria-label="Illustratie van een samenwerking: opdracht, afspraken en uren"
          >
            ...
            <div className={styles.orbitLabel} aria-hidden="true">
              Goed voor elkaar.
            </div>
            <div className={styles.assignment}>
              <div className={styles.cardTop}>
                <span>Een passende opdracht</span>
              ...
              <div className={styles.location}>
                <MapPin size={14} aria-hidden="true" /> Bij jou in de regio
              </div>
              <div className={styles.cardRule} />
              <div className={styles.availability}>
                <span>Jouw beschikbaarheid</span>
            ...
            <div className={styles.agreement}>
              ...
              <div>
                <strong>Afspraken vastgelegd</strong>
                <span>Een helder begin voor allebei.</span>
              </div>
              <Check size={17} aria-hidden="true" />
            </div>
            <div className={styles.hours}>
              <span className={styles.smallLabel}>Na de dienst</span>
              <strong>
                Uren klaar
                <br />
                voor akkoord.
              ...
              <div>
                ...
                <span>De volgende stap is duidelijk</span>
              </div>
            </div>
        ...
        <div className={styles.promiseStrip} aria-label="De basis van Handslag">
          <span>
            <Check size={17} aria-hidden="true" /> Rechtstreeks contact
          </span>
          <span>
            <Check size={17} aria-hidden="true" /> Afspraken bij elkaar
          </span>
          <span>
            <Check size={17} aria-hidden="true" /> Inzicht in de volgende stap
          </span>
        </div>
        ...
        <section id="zo-werkt-het" className={styles.process} aria-labelledby="process-title">
          <div className={styles.processHeading}>
            ...
            <h2 id="process-title">
              Een goed begin.
              <br />
              Een duidelijke <em>volgende stap.</em>
            </h2>
          </div>
        ...
        <section id="overzicht" className={styles.overview} aria-labelledby="overview-title">
          <div className={styles.overviewVisual}>
            <div className={styles.workspace}>
              <div className={styles.workspaceHeader}>
                <BrandMark size={24} />
                <span>Jouw samenwerking</span>
                <span className={styles.example}>Voorbeeld</span>
              </div>
              ...
              <ol className={styles.workflow}>
                <li>
                  <span>01</span>
                  <div>
                    <strong>Opdracht &amp; afspraken</strong>
                    <small>Wat jullie samen hebben afgesproken</small>
                  </div>
                  <Check size={17} aria-hidden="true" />
                </li>
                <li>
                  ...
                  <div>
                    ...
                    <small>Inzicht in beoordeling en geldigheid</small>
                  </div>
                  <Check size={17} aria-hidden="true" />
                </li>
                <li>
                  ...
                  <div>
                    ...
                    <small>Indienen en beoordelen</small>
                  </div>
                ...
                <li>
                  <span>04</span>
                  <div>
                    <strong>Factuur &amp; betaalstatus</strong>
                    <small>Terug te vinden bij de opdracht</small>
                  </div>
                  <ArrowRight size={17} aria-hidden="true" />
                </li>
              </ol>
          ...
          <div className={styles.overviewCopy}>
            ...
            <div className={styles.featureRow}>
              ...
              <div>
                <h3>Afspraken die je terugvindt</h3>
                <p>Houd opdracht, uren en factuur bij dezelfde samenwerking.</p>
              </div>
            </div>
        ...
        <section className={styles.manifesto} aria-label="Waar Handslag voor staat">
          ...
          <p>
            ...
            is mensenwerk.
            <br />
            <em>Dat houden we graag zo.</em>
          </p>
          <div>
            Jullie maken de afspraken.
            <br />
            Handslag helpt het overzicht te bewaren.
          </div>
        </section>

        <section id="vragen" className={styles.faq} aria-labelledby="faq-title">
          <div>
            <p className={styles.eyebrow}>Even helder</p>
            <h2 id="faq-title">
              Goed om
              <br />
              <em>te weten.</em>
            </h2>
            <p>De belangrijkste vragen voordat je begint.</p>
          </div>
        ...
        <section className={styles.closing} aria-labelledby="closing-title">
          <p className={styles.eyebrow}>Klaar voor een kennismaking?</p>
          <h2 id="closing-title">
            Het begint
            <br />
            met <em>elkaar.</em>
          ...
          <div className={styles.closingRingTwo} aria-hidden="true" />
        </section>
      </main>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerTop}>
          ...
          <p>Goed werk begint met een handslag.</p>
          <a href="#inhoud" className={styles.textLink}>
            Terug naar boven ↑
          </a>
        </div>
