// Publieke opdrachtgever-reputatie voor het beslismoment van de ZZP'er op de opdracht-detailpagina.
// Pure aggregatie: bundelt de PUBLISHED beoordelingen die ZZP'ers over een opdrachtgever achterlieten
// (richting FREELANCER_ON_CLIENT) tot één cijfer. Spiegelbeeld van candidate-reviews.ts (de reputatie
