...
const AUDIT_ACTION_LABEL: Record<string, string> = {
  ...
  TWO_FACTOR_ENABLED: "Tweestapsverificatie aangezet",
  TWO_FACTOR_DISABLED: "Tweestapsverificatie uitgezet",
  TWO_FACTOR_CHALLENGE_FAILED: "Mislukte tweestapsverificatie",
  TWO_FACTOR_RECOVERY_CODE_USED: "Herstelcode gebruikt",
  ...
  MAIL_INTAKE_ALIAS_CREATED: "Intake-adres aangemaakt",
  MAIL_INTAKE_ALIAS_ROTATED: "Intake-adres vernieuwd",
  MAIL_INTAKE_ALIAS_DISABLED: "Intake-adres uitgeschakeld",
  ...
  PUSH_SELFTEST_RUN: "Web-push-zelftest uitgevoerd",
};
