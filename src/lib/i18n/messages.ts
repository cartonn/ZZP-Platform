...
const EN: Record<string, string> = {
  ...
  // --- Dagstart-signatuur (dashboard) + paginakoppen ---
  // De motief-eyebrows ("De etalage · …", "Het weefsel · …") zijn vervangen door gewone
  // sectienamen; die staan verderop al als losse termen (Administratie, Mijn profiel, Beheer …).
