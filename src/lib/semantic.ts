...
const STOPWORDS = new Set([
  "de", "het", "een", "en", "van", "voor", "met", "op", "in", "te",
  "aan", "of", "dat", "die", "is", "naar", "bij", "als", "om", "ook",
  "je", "ik", "we", "ze", "hij", "zij", "er", "maar", "niet", "wel",
  "zo", "al", "nu", "nog", "dan", "al", "uit", "door", "over", "tot",
  "zijn", "was", "heeft", "had", "kan", "mag", "moet", "worden",
]);
