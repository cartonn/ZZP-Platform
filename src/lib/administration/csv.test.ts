...
describe("administrationCsv", () => {
  it("bouwt een kop + gesorteerde regels", () => {
    const csv = administrationCsv([
      { occurredAt: new Date("2026-02-10"), account: "DEBITEUREN", debitCents: 0, creditCents: 72600, invoiceId: "i1", correlationId: "c1" },
      { occurredAt: new Date("2026-02-01"), account: "DEBITEUREN", debitCents: 72600, creditCents: 0, invoiceId: "i1", correlationId: "c1" },
    ]);
