...
test("privéprofiel waarschuwt de ZZP'er dat opdrachtgevers hem niet kunnen vinden", async ({ page }) => {
  ...
  await expect(page.getByText("Je profiel staat op privé — opdrachtgevers kunnen je niet vinden")).toBeVisible();
