# Archief CURRENT_TASK.md — t/m augustus 2026

> Verhuisd uit `CURRENT_TASK.md` op 2-9-2026 om de verplichte leeslast per sessie te beperken.
> Dit zijn de **afgeronde** fase-verslagen, cutover-checklists, audit-backlogs en de volledige
> "Gedaan (niet opnieuw)"-historie van de bouw-backlog. Tekst is ongewijzigd overgenomen.
>
> De actuele stand + de nog open backlog staan in [`../../CURRENT_TASK.md`](../../CURRENT_TASK.md).
> Zoek hier vóór je iets bouwt dat al eens gebouwd leek te zijn (`git grep` in dit bestand).
...
0. **Mail-intake (27-8-2026): fase 1 GEBOUWD** — dienstaanvraag per e-mail → inbound-webhook
