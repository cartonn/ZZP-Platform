 ...
 *
 * Vereist de PostgreSQL-client (`pg_dump`) op het systeem. Inert/onschadelijk lokaal (SQLite):
 * faalt dan met een heldere melding i.p.v. iets te overschrijven.
 */
...
function main(): void {
  ...
  console.log(`[backup] klaar: ${outFile} (${bytes} bytes)`);
